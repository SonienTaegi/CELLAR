...
urlpatterns = patterns('',  
    ...
    url(r'^(?P<path>.+\.css)$'          , 'django.views.static.serve', {'document_root' : settings.BASE_DIR + '/Browser/templates'}),
    url(r'^static/(?P<path>.*)$'        , 'django.views.static.serve', {'document_root' : settings.BASE_DIR + '/Browser/static'}),    
)